...
def validate_api_key():
    ...
    api_key = os.getenv("OPENAI_API_KEY", "sk-proj-nSQrYldL5lK8zpYbOzzYNK16NZLpvT1vKAmhzddAjO9CfFSY2zumZ9 gp1udlwjhxx0i5_KUR0lT3BlbkFJK4S0A8kNV9LzD8P2bMDrl2S9Q7VKOSTmC8uE41MiMZoipiTUryXIpDn2oAosYQMDXwB829ehgA")
...
def download_s3_folder(s3_prefix, local_path):
...
class OutputFormatterAgent:
    """Agent to save output as CSV and Markdown to S3."""
    def __init__(self, ticker: str):
        self.ticker = ticker
        self.s3_output_dir = f"filings/{ticker}"
    ...
    def save_output(self, drug_data: list):
        ...
        try:
            ...
            csv_key = f"{self.s3_output_dir}/drug_summary.csv"
            ...
            # Save Markdown to S3
            md_key = f"{self.s3_output_dir}/drug_summary.md"
...
def main():
    ...
    try:
        ...
        # Agent 4: Format and save output to S3
